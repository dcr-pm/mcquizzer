  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center z-50 backdrop-blur-sm">
      <form
        ...
        className="bg-gray-800 p-8 rounded-xl shadow-2xl border border-gray-700 transform transition-all animate-fade-in-up"
      >
        <h2 className="text-2xl font-bold text-white mb-4">Enter Your Name</h2>
        <p className="text-gray-400 mb-6">Your name will be displayed on the leaderboard.</p>
        <input
          type="text"
          value={name}
